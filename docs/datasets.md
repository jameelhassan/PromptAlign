...
### Acknowledgement: This readme file for installing datasets has been borrowed with minor edit, directly from [MaPLe's]([https://github.com/KaiyangZhou/CoOp/blob/main/DATASETS.md](https://github.com/muzairkhattak/multimodal-prompt-learning/edit/main/docs/DATASETS.md)) official repository.
...
### PUG-ImageNet
- Download the PUG-ImageNet dataset from the [official website](https://pug.metademolab.com/) and extract the testing set to `$DATA/`. The directory structure should look like
```
PUG_ImageNet/
|–– Camera_Pitch/  # contains 151 folders like with the classname as the folder name
|–– Camera_Roll/ and so on...
```
- If you had downloaded the dataset before, you can create symbolic links to map it to `$DATA/PUG_ImageNet`.
- Download the `classnames.txt` to `$DATA/PUG_ImageNet/` from this [link]([https://drive.google.com/file/d/1-61f_ol79pViBFDG_IDlUQSwoLcn2XXF/view?usp=sharing](https://drive.google.com/drive/folders/1VwLorkHbEnZBqM6EuQcxQc3AtoLxyc_L)).
